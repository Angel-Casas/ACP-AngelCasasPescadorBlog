...
// Home page route.
router.get('/', function (req, res) { res.redirect("/ES") });
...
router.post('/:lang/posts/:section/:id/comment', commentController.post_comment_post);

// POST request for deleting comment
router.post('/:lang/posts/:section/:id/delete_comment', authorization, commentController.delete_comment_post);

// POST request for approving comment
router.post('/:lang/posts/:section/:id/approve', authorization, commentController.approve_comment_post);
...
router.get('/:lang/posts/:section/:id/edit', authorization, postController.post_edit_get);

// POST request for editing post PRIVATE
router.post('/:lang/posts/:section/:id/edit', authorization, postController.post_edit_post);

// GET request for deleting post PRIVATE
router.get('/:lang/posts/:section/:id/delete', authorization, postController.post_delete_get);

// POST request for deleting post PRIVATE
router.post('/:lang/posts/:section/:id/delete', authorization, postController.post_delete_post);
